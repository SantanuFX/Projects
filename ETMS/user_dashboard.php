...
<html>
    <head>
        <title>ETMS|User Dashboard</title>
        <!-- jQuery file -->
        ...
        <div class="row" id="header">
            <div class="col-md-12">
                <div class="col-md-8" style="display: inline-block;">
                    <h3><i class=" fa fa-solid fa-list" style="padding-right: 15px;"></i> Employee Task Management System</h3><b><i>
                </div>
                <div class="col-md-14" style="text-align: right;display: inline-block;">
