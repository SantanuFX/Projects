...
<body>
    <div class="row">
        <div class="col-md-3 m-auto" id="register_home_page">
            <center><h3><center><b>User Registration</b></center></h3></center>
            <form action="" method="post">
                ...
                <div class="form-group">
                    <center><input type="submit" class="btn btn-success" name="userRegistration" value="Register"></center>
                </div>
            </form>
            <center><a href="index.php" class="btn btn-outline-danger">Go to Home</a></center>
        </div>
    </div>
</body>
</html>